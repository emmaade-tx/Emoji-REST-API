...
//             $user = $this->schema->createUserTable(['fullname' => 'John Test', 'username' => 'tester', 'password' => password_hash('test', PASSWORD_DEFAULT)]);
//             var_dump($user);
//             exit;
//             $user2 = $this->schema->createUserTable(['fullname' => 'John Test2', 'username' => 'tester2', 'password' => password_hash('test', PASSWORD_DEFAULT)]);
